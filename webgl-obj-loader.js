...
obj_utils.bindRenderingContext = function(renderingContext){
...
obj_utils.downloadMeshes = function( nameAndURLs, completionCallback ){
    ...
    $.when.apply( $, ajaxes ).done(function(){
        completionCallback( meshes, boundRenderingContext.gl, boundContainer);
    });
}

let boundContainer;
obj_utils.bindContainer = function(container){
